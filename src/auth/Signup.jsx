            ...
            <div className="w-full max-w-5xl mx-auto px-4 sm:px-0">
                ...
                <div className="rounded-2xl shadow-2xl overflow-hidden animate-fadeIn"
                    ...
                    <div className="flex flex-col lg:flex-row">
                        ...
                        {/* Right Panel - Form with 2-Column Layout */}
                        <div className="flex-1 p-8 md:p-10 lg:p-14">
                                ...
                                <div className="mb-6 animate-fadeIn">
                                    ...
                                    {success && (
                                        <div className="p-4 rounded-xl flex items-center gap-3"
                                            ...
                                            <svg className="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" style={{ color: "var(--accent-success)" }}>
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                            </svg>
                                            <span className="text-sm font-medium" style={{ color: "var(--accent-success)" }}>{success}</span>
                                        </div>
                                    )}
                                </div>
                            )}
                            ...
                            <form onSubmit={handleSubmit}>
                                {/* 2-Column Grid Layout - Each row has 2 fields */}
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                ...
                                                <select
                                                    ...
                                                    value={formData.sex}
                                                    onChange={handleChange}
                                                    className="w-full pl-10 pr-10 py-3 rounded-xl border appearance-none transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[var(--accent-success)] focus:border-transparent cursor-pointer"
                                                    style={{
                                                        backgroundColor: 'var(--bg-tertiary)',
                                                        borderColor: 'var(--border-primary)',
                                                        color: 'var(--text-primary)'
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                ...
                                                <input
                                                    ...
                                                    onChange={handleChange}
                                                    className="w-full pl-10 pr-10 py-3 rounded-xl border transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[var(--accent-success)] focus:border-transparent"
                                                    style={{
                                                        backgroundColor: 'var(--bg-tertiary)',
                                                        borderColor: 'var(--border-primary)',
                                                        color: 'var(--text-primary)'
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                ...
                                                <input
                                                    ...
                                                    onChange={handleChange}
                                                    className={`w-full pl-10 pr-10 py-3 rounded-xl border transition-all duration-200 focus:outline-none focus:ring-2 ${!passwordMatch && formData.confirmPassword ? 'focus:ring-red-500' : 'focus:ring-[var(--accent-success)]'}`}
                                                    style={{
                                                        backgroundColor: 'var(--bg-tertiary)',
                                                        borderColor: !passwordMatch && formData.confirmPassword ? '#ef4444' : 'var(--border-primary)',
                                                        color: 'var(--text-primary)'
                                                    }}
                                ...
                                <div className="mt-8 space-y-3">
                                    ...
                                    <div className="relative">
                                        ...
                                        <div className="relative flex justify-center text-xs uppercase">
                                            <span className="px-3 bg-[var(--bg-secondary)]" style={{ color: 'var(--text-tertiary)' }}>or</span>
                                        </div>
                                    </div>
